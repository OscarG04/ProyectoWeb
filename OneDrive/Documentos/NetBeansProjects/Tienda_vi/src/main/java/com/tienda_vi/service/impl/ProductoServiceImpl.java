...
public class ProductoServiceImpl implements ProductoService {
    ...
    @Override
    @Transactional(readOnly=true)
    public List<Producto> consultaJPApractica(double existenciasMen, double existenciasMay){
        return productoDao.findByPrecioBetweenOrderByDescripcion(existenciasMen, existenciasMay);
    }
